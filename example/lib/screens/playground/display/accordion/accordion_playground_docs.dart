...
class AccordionPlaygroundDocs extends StatelessWidget {
  const AccordionPlaygroundDocs({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        children: [
          ...
          _buildRow('title', 'String', 'Title text header'),
          _buildRow('subtitle', 'String?', 'Secondary description label next/below title'),
          _buildRow('children', 'List<Widget>', 'Collapsible contents nested inside panel'),
          _buildRow('initiallyExpanded', 'bool', 'If panel is open on first frame rendering'),
        ],
      ),
    );
  }
