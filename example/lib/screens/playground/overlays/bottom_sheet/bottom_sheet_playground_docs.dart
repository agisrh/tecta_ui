...
class BottomSheetPlaygroundDocs extends StatelessWidget {
  const BottomSheetPlaygroundDocs({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        children: [
          ...
          _buildRow('title', 'String?', 'The header title string text'),
          _buildRow('showDragHandle', 'bool', 'If the drag control pill handle is visible'),
          _buildRow('child', 'Widget', 'The sheet body content layout template'),
        ],
      ),
    );
  }
