...
class TooltipPlaygroundDocs extends StatelessWidget {
  const TooltipPlaygroundDocs({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        children: [
          ...
          _buildRow('message', 'String', 'The tooltip text popped up on hovering/pressing'),
          _buildRow('position', 'TectaTooltipPosition', 'Direction overlay alignment (top/bottom/left/right)'),
          _buildRow('child', 'Widget', 'The target child element wrapped to trigger the overlay'),
        ],
      ),
    );
  }
