...
class DropdownMenuPlaygroundDocs extends StatelessWidget {
  const DropdownMenuPlaygroundDocs({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        children: [
          ...
          _buildRow('items', 'List<TectaDropdownMenuItem>', 'The action option items list rendered inside overlay'),
          _buildRow('child', 'Widget', 'The target child element anchored to toggle the dropdown overlay'),
        ],
      ),
    );
  }
