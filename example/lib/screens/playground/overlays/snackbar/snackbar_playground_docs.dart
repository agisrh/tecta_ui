...
class SnackbarPlaygroundDocs extends StatelessWidget {
  const SnackbarPlaygroundDocs({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        children: [
          ...
          _buildRow('message', 'String', 'The message content shown in the notification toast'),
          _buildRow('variant', 'TectaSnackbarVariant', 'Layout accent variant (minimal, info, success, warning, error)'),
          _buildRow('actionLabel', 'String?', 'Action button label text triggers action trigger callback'),
        ],
      ),
    );
  }
