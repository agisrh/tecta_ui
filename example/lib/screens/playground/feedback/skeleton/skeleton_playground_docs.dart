...
class SkeletonPlaygroundDocs extends StatelessWidget {
  const SkeletonPlaygroundDocs({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        children: [
          ...
          _buildRow('width', 'double', 'Shimmer bounding box width'),
          _buildRow('height', 'double', 'Shimmer bounding box height'),
          _buildRow('shape', 'BoxShape', 'Shape form of skeleton placeholder (rectangle/circle)'),
          _buildRow('borderRadius', 'BorderRadius', 'Curve shape outline (for BoxShape.rectangle)'),
        ],
      ),
    );
  }
