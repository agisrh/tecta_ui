...
class SliderPlaygroundDocs extends StatelessWidget {
  const SliderPlaygroundDocs({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        children: [
          ...
          _buildRow('value', 'double', 'The currently selected value of the slider'),
          _buildRow('min', 'double', 'The minimum selectable value (defaults to 0.0)'),
          _buildRow('max', 'double', 'The maximum selectable value (defaults to 1.0)'),
          _buildRow('onChanged', 'ValueChanged<double>?', 'Callback trigger as slider changes values'),
        ],
      ),
    );
  }
