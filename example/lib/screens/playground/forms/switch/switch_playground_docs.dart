...
class SwitchPlaygroundDocs extends StatelessWidget {
  const SwitchPlaygroundDocs({super.key});
    ...
    return SingleChildScrollView(
      ...
      child: Table(
        ...
        children: [
          ...
          _buildRow('label', 'String', 'Optional label text displayed alongside the switch toggle'),
          _buildRow('value', 'bool', 'Current state (on/off) of the toggle'),
